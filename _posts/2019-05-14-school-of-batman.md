...
It's immediately clear that millions of compounds can't really be handled well on your average laptop. To play around with molecule clusters, you should try out [Faerun](https://interactive.sketchmap.org/Lysine-Dipeptide).
